<table class="job-manager-past-applications">
	<tr>
		<th><?php esc_html_e( 'Job', 'capstone' ); ?></th>
		<th><?php esc_html_e( 'Date Applied', 'capstone' ); ?></th>
		<th><?php esc_html_e( 'Status', 'capstone' ); ?></th>
		<th><?php esc_html_e( 'Application Message', 'capstone' ); ?></th>
	</tr>
